      ...
      <div className="relative bg-slate-900 border border-slate-800 rounded-[2rem] p-8 max-w-sm w-full shadow-2xl animate-in zoom-in-95 fade-in duration-200">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex w-full gap-3 mt-8">
            <button
              onClick={onClose}
              className="flex-1 px-6 py-3 rounded-2xl bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold transition"
            >
              Cancel
            </button>
            <button
              onClick={onConfirm}
              className="flex-1 px-6 py-3 rounded-2xl bg-red-600 hover:bg-red-500 text-white font-semibold transition shadow-lg shadow-red-900/20"
            >
              Delete
            </button>
          </div>
